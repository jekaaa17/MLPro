...
import { SEARCH_MARKSMAN } from "../actions/index.jsx";
...
const marksmanReducer = (state = initialState, action) => {
  switch (action.type) {
    case SEARCH_MARKSMAN:
      const { payload } = action;
      const filtered = _.filter(state.marksman, (o) =>
...
export default marksmanReducer;
