...
import { SEARCH_ASSASIN } from "../actions/index.jsx";
...
const assasinReducer = (state = initialState, action) => {
  switch (action.type) {
    case SEARCH_ASSASIN:
      const { payload } = action;
      const filtered = _.filter(state.assasin, (o) =>
